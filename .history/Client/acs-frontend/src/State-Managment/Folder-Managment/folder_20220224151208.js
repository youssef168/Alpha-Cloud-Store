...
export const callFolderRequired = (location) => {
    return (dispatch, getState) => {
        ...
        if (user.id && folderData.id && folderRoute === folderData.id) {
            return dispatch(getFolder(folderRoute))
        }
    }
}
